...
export const en = {
  ...
  reasoningInherit: 'Use what this model is known to support',
  reasoningNone: 'No reasoning',
  reasoningCustom: 'Declare the levels this model offers',
  reasoningWire: 'Value to send',
  reasoningWireOff: 'Send nothing',
  reasoningNeedsLevel: 'Declare a level beyond off, or choose “No reasoning”.',
  reasoningNeedsWire: 'Every level except off needs the value to send.',
  addModel: 'Add model',
  ...
  thinking: 'Thinking',
  thinkingInherited: 'Provider default',
  thinkingEnabled: 'Enabled',
  thinkingDisabled: 'Disabled',
  reasoningEffort: 'Default reasoning effort',
  reasoningEffortInherited: 'Provider default',
  reasoningEffortOffOnly: 'Off (thinking is disabled)',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modalityImage: '图片',
  modelReasoning: '思考强度',
  reasoningInherit: '沿用该模型已知的能力',
  reasoningNone: '不支持思考',
  reasoningCustom: '声明该模型提供的强度档位',
  reasoningWire: '发送的取值',
  reasoningWireOff: '不发送',
  reasoningNeedsLevel: '请至少声明 off 以外的一档，或选择「不支持思考」。',
  reasoningNeedsWire: 'off 以外的每一档都需要填写发送的取值。',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  customApiUnset: '未选择',
  thinking: '思考',
  thinkingInherited: '提供方默认',
  thinkingEnabled: '开启',
  thinkingDisabled: '关闭',
  reasoningEffort: '默认推理强度',
  reasoningEffortInherited: '提供方默认',
  reasoningEffortOffOnly: 'Off（思考已关闭）',
